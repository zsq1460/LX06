...
namespace DAL
{
    public class Comment
    {
        ...
        public int Add(Model.Comment comment)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "insert into Comment(commentID,workI,userName,CommentContent,CommentTime)" +
        ...
        public int Update(Model.Comment comment)
        {
            ...
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "update Comment set CommentContent=@CommentContent,CommentTime=@CommentContent whrere commentID=@commentID";
